...
export class ApiClient {
  ...
  public async callKickApi(params: CallKickAPICycles) {
    ...
    const xsrfToken = cookie ? decodeURIComponent(cookie.split('XSRF-TOKEN=')[1]?.split(';')?.[0]) : ''

    const defaultOptions: CycleTLSRequestOptions = {
      ja3: '771,4865-4867-4866-49195-49199-52393-52392-49196-49200-49162-49161-49171-49172-51-57-47-53-10,0-23-65281-10-11-35-16-5-51-43-13-45-28-21,29-23-24-25-256-257,0',
      userAgent: 'KICK/40.4.11 Dalvik/2.1.0(Linux; U; Android 13; Pixel 6 Pro Build / TQ1A.221205.011)',
